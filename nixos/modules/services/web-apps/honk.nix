  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.honk = {
      ...
      preStart = ''
        ...
        ${lib.optionalString (cfg.extraJS != null) "ln -s ${cfg.extraJS} $STATE_DIRECTORY/views/local.js"}
        ${lib.optionalString (cfg.extraCSS != null) "ln -s ${cfg.extraCSS} $STATE_DIRECTORY/views/local.css"}
